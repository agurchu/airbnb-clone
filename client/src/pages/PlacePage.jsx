...
export default function PlacePage() {
  ...
  const [checkTime, setCheckTime] = useState([
    { title: "Check in time", placeholder: "14:00" },
    { title: "Check out time", placeholder: "18:00" },
    { title: "Max number of guests", placeholder: "3" },
  ]);
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              {checkTime?.map((check) => (
                <div key={check.title}>
                  ...
                  <input type="text" placeholder={check.placeholder} />
                </div>
              ))}
            </div>
